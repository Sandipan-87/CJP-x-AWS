...
_route_after_observe and _route_after_gate are the two parts of graph.py
testable without a cluster/LangGraph runtime -- everything else in that
module is exercised live by scripts/smoke_test_graph.py.
"""
...
from agent.graph import _route_after_gate, _route_after_observe
